...
exports.fromQuorumWallet = exports.fromEtherCamp = exports.fromEtherWallet = void 0;
...
async function fromEtherWallet(input, password) {
    ...
    if (!json.locked) {
        ...
        const pr = await (0, aes_1.decrypt)(cipher.ciphertext, evp.key, evp.iv, 'aes-256-cbc');
        // NOTE: yes, they've run it through UTF8
        privateKey = Buffer.from((0, utils_1.bytesToUtf8)(pr), 'hex');
    }
...
function fromEtherCamp(passphrase) {
    return new index_1.default(Buffer.from((0, keccak_1.keccak256)(Buffer.from(passphrase))));
}
...
function fromQuorumWallet(passphrase, userid) {
    ...
    const merged = (0, utils_1.utf8ToBytes)(passphrase + userid);
    const seed = (0, pbkdf2_1.pbkdf2Sync)(merged, merged, 2000, 32, 'sha256');
    return new index_1.default(Buffer.from(seed));
}
